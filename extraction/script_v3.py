...
class JobicyAPI:
    ...
    #método para requisitar os dados da API e salvar num atribuito da própria classe
    def fetch_data(self):
...
def main():
    ...
    if not jobs_df.empty:
        ...
        saver.save_to_snowflake(jobs_df, table_name="listagem_trabalhos_remotos")
